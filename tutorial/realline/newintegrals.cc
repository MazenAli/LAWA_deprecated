...
typedef BSpline<T,Primal,R,CDF> PrimalSpline;
typedef BSpline<T,Dual,R,CDF>   DualSpline;
typedef Wavelet<T,Primal,R,CDF> PrimalWavelet;
typedef Wavelet<T,Dual,R,CDF>   DualWavelet;
