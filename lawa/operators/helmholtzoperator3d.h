...
class HelmholtzOperator3D{
    ...
    public:
        ...
        typedef WeakLaplaceOperator1D<T, typename Basis3D::FirstBasisType>   Diffusion_x;
        typedef RieszOperator1D<T, typename Basis3D::FirstBasisType> 	     Reaction_x;
        typedef WeakLaplaceOperator1D<T, typename Basis3D::SecondBasisType>  Diffusion_y;
        typedef RieszOperator1D<T, typename Basis3D::SecondBasisType> 	     Reaction_y;
        typedef WeakLaplaceOperator1D<T, typename Basis3D::ThirdBasisType>   Diffusion_z;
        typedef RieszOperator1D<T, typename Basis3D::ThirdBasisType> 	     Reaction_z;
...
#include <lawa/operators/helmholtzoperator3d.tcc>

#endif // LAWA_ADAPTIVE_HELMHOLTZOPERATOR3D_H
