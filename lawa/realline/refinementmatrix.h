...
#ifndef LAWA_REALLINE_REFINEMENTMATRIX_H
#define LAWA_REALLINE_REFINEMENTMATRIX_H 1
...
#include <lawa/realline/refinementmatrix.tcc>

#endif // LAWA_REALLINE_REFINEMENTMATRIX_H
