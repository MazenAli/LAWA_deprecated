#ifndef LAWA_CONSTRUCTIONS_SPARSEMULTI_RPLUS_BSPLINE_H
#define LAWA_CONSTRUCTIONS_SPARSEMULTI_RPLUS_BSPLINE_H 1
...
#include <lawa/constructions/sparsemulti/rplus/bspline.tcc>

#endif // LAWA_CONSTRUCTIONS_SPARSEMULTI_RPLUS_BSPLINE_H
