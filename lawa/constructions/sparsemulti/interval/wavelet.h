...
#ifndef LAWA_CONSTRUCTIONS_SPARSEMULTI_INTERVAL_WAVELET_H
#define LAWA_CONSTRUCTIONS_SPARSEMULTI_INTERVAL_WAVELET_H 1
...
#include <lawa/constructions/sparsemulti/interval/wavelet.tcc>

#endif // LAWA_CONSTRUCTIONS_SPARSEMULTI_INTERVAL_WAVELET_H
