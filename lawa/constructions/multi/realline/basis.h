...
#ifndef LAWA_CONSTRUCTIONS_MULTI_REALLINE_BASIS_H
#define LAWA_CONSTRUCTIONS_MULTI_REALLINE_BASIS_H 1
...
#include <lawa/constructions/multi/realline/basis.tcc>

#endif // LAWA_CONSTRUCTIONS_MULTI_REALLINE_BASIS_H
