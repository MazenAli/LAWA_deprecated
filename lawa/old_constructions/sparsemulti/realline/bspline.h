#ifndef LAWA_CONSTRUCTIONS_SPARSEMULTI_REALLINE_BSPLINE_H
#define LAWA_CONSTRUCTIONS_SPARSEMULTI_REALLINE_BSPLINE_H 1
...
#include <lawa/constructions/sparsemulti/realline/bspline.tcc>

#endif // LAWA_CONSTRUCTIONS_SPARSEMULTI_REALLINE_BSPLINE_H
