...
#ifndef LAWA_CONSTRUCTIONS_SPARSEMULTI_REALLINE_WAVELET_H
#define LAWA_CONSTRUCTIONS_SPARSEMULTI_REALLINE_WAVELET_H 1
...
#include <lawa/constructions/sparsemulti/realline/wavelet.tcc>

#endif // LAWA_CONSTRUCTIONS_SPARSEMULTI_REALLINE_WAVELET_H
