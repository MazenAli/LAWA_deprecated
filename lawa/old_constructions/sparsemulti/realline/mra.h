#ifndef LAWA_CONSTRUCTIONS_SPARSEMULTI_REALLINE_MRA_H
#define LAWA_CONSTRUCTIONS_SPARSEMULTI_REALLINE_MRA_H 1
...
#include <lawa/constructions/sparsemulti/realline/mra.tcc>

#endif // LAWA_CONSTRUCTIONS_SPARSEMULTI_REALLINE_MRA_H
