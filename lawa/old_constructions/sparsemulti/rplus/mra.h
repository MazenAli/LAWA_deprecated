#ifndef LAWA_CONSTRUCTIONS_SPARSEMULTI_RPLUS_MRA_H
#define LAWA_CONSTRUCTIONS_SPARSEMULTI_RPLUS_MRA_H 1
...
#include <lawa/constructions/sparsemulti/rplus/mra.tcc>

#endif // LAWA_CONSTRUCTIONS_SPARSEMULTI__RPLUS_MRA_H
