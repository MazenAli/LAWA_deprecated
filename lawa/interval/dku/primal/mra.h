...
#ifndef LAWA_INTERVAL_DKU_PRIMAL_MRA_H
#define LAWA_INTERVAL_DKU_PRIMAL_MRA_H 1
...
class MRA<_T,Primal,Interval,DKU>
{
    public:
        ...
        typedef BasisFunction<T,Primal,Interval,DKU> BasisFunction;
...
#include <lawa/interval/dku/primal/mra.tcc>

#endif //LAWA_INTERVAL_DKU_PRIMAL_MRA_H