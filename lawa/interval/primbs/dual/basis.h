...
#ifndef LAWA_INTERVAL_PRIMBS_DUAL_BASIS_H
#define LAWA_INTERVAL_PRIMBS_DUAL_BASIS_H 1
...
#include <lawa/interval/primbs/dual/basis.tcc>

#endif // LAWA_INTERVAL_PRIMBS_DUAL_BASIS_H