...
CompressionPDE2D<T,Basis2D>::CompressionPDE2D(const Basis2D &_basis, bool _levelthresh)
    : basis(_basis), s_tilde_x(-1), jmin_x(100), jmax_x(-30),
      s_tilde_y(-1), jmin_y(100), jmax_y(-30), J(0), levelthresh(_levelthresh)
{
}
