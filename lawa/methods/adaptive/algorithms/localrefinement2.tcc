...
template <typename PrimalBasis>
void
LocalRefinement2<PrimalBasis>::reconstructOnlyMultiScaling
...
template <typename PrimalBasis>
void
LocalRefinement2<PrimalBasis>::reconstructBSpline(int j, long k, T coeff,
...
template <typename PrimalBasis>
void
LocalRefinement2<PrimalBasis>::reconstructWavelet(int j, long k, T coeff,
                                                  CoefficientsByLevel<T> &u_loc_single,
                                                  int &j_refinement) const
{
    DenseVectorLD *refCoeffs;
...
template <typename PrimalBasis>
void
LocalRefinement2<PrimalBasis>::decompose_(const CoefficientsByLevel<T>  &u_loc_single,
...
template <typename PrimalBasis>
void
LocalRefinement2<PrimalBasis>::decompose_OnlyMultiScaling(const CoefficientsByLevel<T>  &u_loc_single,
...
LocalRefinement2<PrimalBasis>::decompose_Scaling(const CoefficientsByLevel<T> &u_loc_single,
                                                 int j, long k) const
{
...
template <typename PrimalBasis>
typename PrimalBasis::T
LocalRefinement2<PrimalBasis>::decompose_BSpline(const CoefficientsByLevel<T> &u_loc_single,
                                                 int j, long k) const
{
    const_coeffbylevel_it u_loc_single_end = u_loc_single.map.end();
    const_coeffbylevel_it u_loc_single_ptr;
...
template <typename PrimalBasis>
typename PrimalBasis::T
LocalRefinement2<PrimalBasis>::decompose_Wavelet(const CoefficientsByLevel<T> &u_loc_single,
                                                 int j, long k) const
{
    const_coeffbylevel_it u_loc_single_end = u_loc_single.map.end();
    const_coeffbylevel_it u_loc_single_ptr;
