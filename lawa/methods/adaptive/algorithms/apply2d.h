...
#ifndef LAWA_ADAPTIVE_ALGORITHMS_APPLY2D_H
#define LAWA_ADAPTIVE_ALGORITHMS_APPLY2D_H 1
...
#include <lawa/adaptive/algorithms/apply2d.tcc>

#endif // LAWA_ADAPTIVE_ALGORITHMS_APPLY2D_H
