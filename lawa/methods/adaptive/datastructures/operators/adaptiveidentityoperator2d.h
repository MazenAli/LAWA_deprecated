...
#define LAWA_METHODS_ADAPTIVE_DATASTRUCTURES_OPERATORS_ADAPTIVEIDENTITYOPERATOR2D_H
...
class AdaptiveIdentityOperator2D
{
...
public:
    ...
    AdaptiveIdentityOperator2D(const Basis2D &_basis2d, T _entrybound=0.,
