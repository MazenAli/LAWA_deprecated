...
WeightedLaplaceOperator2D<T, Basis>::WeightedLaplaceOperator2D(const Basis& _basis, 
                                                               Function<T> weightFct_x, 
                                                               Function<T> weightFct_y)
    : basis(_basis), W_x(weightFct_x), W_y(weightFct_y),
...
template <typename T, typename Basis>
T
WeightedLaplaceOperator2D<T, Basis>::operator()(XType row_xtype_x, int j1_x, int k1_x,
...
template <typename T, typename Basis>
T
WeightedLaplaceOperator2D<T, Basis>::operator()(const Index2D &row_index, const Index2D &col_index) const
{
