...
{
    assert(j>=j0);
    return Range<Integer>(0,cardI(j)-1);
}
...
{
    return Range<Integer>(0,cardIL() - 1);
}
...
{
    assert(j>=j0);
    return Range<Integer>(cardIL(), cardIL()+cardII(j)-1);
}
...
{
    assert(j>=j0);
    return Range<Integer>(cardIL()+cardII(j),cardI(j)-1);
}
