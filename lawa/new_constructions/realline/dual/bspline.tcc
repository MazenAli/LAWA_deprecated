#ifndef LAWA_CONSTRUCTIONS_REALLINE_DUAL_BSPLINE_TCC
#define LAWA_CONSTRUCTIONS_REALLINE_DUAL_BSPLINE_TCC 1
...
_calculate_bspline_mask(int d, int d_)
{
    ...
    for ( Integer  i=res.firstIndex(); i<=res.lastIndex(); ++i) {
...
#endif // LAWA_CONSTRUCTIONS_REALLINE_DUAL_BSPLINE_TCC
