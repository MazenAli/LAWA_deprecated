#ifndef LAWA_CONSTRUCTIONS_REALLINE_MULTI_WAVELET_TCC
#define LAWA_CONSTRUCTIONS_REALLINE_MULTI_WAVELET_TCC 1
...
template <typename T>
T
Wavelet<T,Orthogonal,R,Multi>::operator()(T x, int j, Integer k, unsigned short deriv) const
{
...
template <typename T>
Integer
Wavelet<T,Orthogonal,R,Multi>::_shift(Integer k) const
{
...
template <typename T>
int
Wavelet<T,Orthogonal,R,Multi>::_type(Integer k) const
{
...
#endif // LAWA_CONSTRUCTIONS_REALLINE_MULTI_WAVELET_TCC
