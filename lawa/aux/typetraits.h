...
struct IsPrimal<Wavelet<T, Primal, Domain, Cons> >
{
    static const bool value = true;
};

template <typename T, DomainType Domain, Construction Cons>
struct IsPrimal<BSpline<T, Primal, Domain, Cons> >
{
    static const bool value = true;
};
...
template <typename T, DomainType Domain, Construction Cons>
struct IsDual<Wavelet<T, Dual, Domain, Cons> >
{
    static const bool value = true;
};

template <typename T, DomainType Domain, Construction Cons>
struct IsDual<BSpline<T, Dual, Domain, Cons> >
{
    static const bool value = true;
};
