                                        ...
                                        int j2_x, int k2_x, int j2_y, int k2_y) const
{
    ...
    if(FirstXisSpline){
         if(SecondXisSpline){
             ...
             bval_x = d_phi_x(1., j1_x, k1_x)*phi_x(1., j2_x, k2_x) - d_phi_x(0., j1_x, k1_x)*phi_x(0., j2_x, k2_x);
         }
         else{
             val_x = integral_sfw_x(j1_x, k1_x, j2_x, k2_x);
             dd_val_x = dd_integral_sfw_x(j1_x, k1_x, j2_x, k2_x);
             bval_x = d_phi_x(1., j1_x, k1_x)*psi_x(1., j2_x, k2_x) - d_phi_x(0., j1_x, k1_x)*psi_x(0., j2_x, k2_x);
         }
    }
    else{
         if(SecondXisSpline){
             ...
             bval_x = d_psi_x(1., j1_x, k1_x)*phi_x(1., j2_x, k2_x) - d_psi_x(0., j1_x, k1_x)*phi_x(0., j2_x, k2_x);
         }
         else{
             val_x = integral_ww_x(j1_x, k1_x, j2_x, k2_x);
             dd_val_x = dd_integral_ww_x(j1_x, k1_x, j2_x, k2_x);
             bval_x = d_psi_x(1., j1_x, k1_x)*psi_x(1., j2_x, k2_x) - d_psi_x(0., j1_x, k1_x)*psi_x(0., j2_x, k2_x);
         }
    }
    ...
    if(FirstYisSpline){
         if(SecondYisSpline){
             ...
             bval_y = d_phi_y(1., j1_y, k1_y)*phi_y(1., j2_y, k2_y) - d_phi_y(0., j1_y, k1_y)*phi_y(0., j2_y, k2_y);
         }
         else{
             val_y = integral_sfw_y(j1_y, k1_y, j2_y, k2_y);
             dd_val_y = dd_integral_sfw_y(j1_y, k1_y, j2_y, k2_y);
             bval_y = d_phi_y(1., j1_y, k1_y)*psi_y(1., j2_y, k2_y) - d_phi_y(0., j1_y, k1_y)*psi_y(0., j2_y, k2_y);
         }
    }
    else{
         if(SecondYisSpline){
             ...
             bval_y = d_psi_y(1., j1_y, k1_y)*phi_y(1., j2_y, k2_y) - d_psi_y(0, j1_y, k1_y)*phi_y(0., j2_y, k2_y);
         }
         else{
             val_y = integral_ww_y(j1_y, k1_y, j2_y, k2_y);
             dd_val_y = dd_integral_ww_y(j1_y, k1_y, j2_y, k2_y);
             bval_y = d_psi_y(1., j1_y, k1_y)*psi_y(1., j2_y, k2_y) - d_psi_y(0., j1_y, k1_y)*psi_y(0., j2_y, k2_y);
         }
    }
