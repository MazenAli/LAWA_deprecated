...
class SeparableRHSwithPeaks
{
    private:
        ...
        Integral<T, Trapezoidal, PrimalSpline_x, Function<T> > integral_sff_x, peak_integral_sff_x;
        Integral<T, Trapezoidal, PrimalSpline_y, Function<T> > integral_sff_y, peak_integral_sff_y;
        Integral<T, Trapezoidal, PrimalWavelet_x, Function<T> > integral_wf_x, peak_integral_wf_x;
        Integral<T, Trapezoidal, PrimalWavelet_y, Function<T> > integral_wf_y, peak_integral_wf_y;
