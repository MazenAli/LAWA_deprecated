/*
 * indexset_rb_example_training_output.cpp
 *
 *  Created on: 14.09.2011
 *      Author: s_sglas
 */

//Erweiterung (und Veränderung) des indexset_rb_example_training.cpp
...
int main(int argc, char* argv[]) {
    ...
    /*Affine Decomposition Output Functional and Output Functional*/
    ...
    readIndexSet2D<T>(basisset, filename.str().c_str(),false);
