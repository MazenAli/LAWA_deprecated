...
typedef WeightedLaplaceOperator2D<T, Basis2D>				            WeightedLaplaceOp2D;
...
int main(int argc, char* argv[]) {
    ...
    cout << "N = " << rb_model.rb_basis_functions.size() << endl;
    cout << "F = " << rb_model.RB_F_vectors[0] << endl;
    cout << "A = " << rb_model.RB_A_matrices[0] << endl;
    ...
    // plot2D(basis2d, u, prec, plot_dummy_fct, 0., 1., 0., 1., 0.01, "adaptive_rb_example");
