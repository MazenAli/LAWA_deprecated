...
typedef Basis<T,Primal,R,SparseMulti>                               SparseMWBasis;
...
int main(int argc, char *argv[]) {
    ...
    BSpline<T,Primal,R,SparseMulti> phi(d);
    Wavelet<T,Primal,R,SparseMulti> psi(d);
    ...
    ofstream plotfile_scaling("realline_sparsemultiscaling.txt");
    ...
    ofstream plotfile_wavelet("realline_sparsemultiwavelet.txt");
