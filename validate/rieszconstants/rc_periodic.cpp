...
typedef AdaptiveIdentityOperator1D<T,Primal, Periodic, CDF>   			IdentityOp;
typedef AdaptiveLaplaceOperator1D<T,Primal, Periodic, CDF>   			LaplaceOp;
...
int main(int argc, char *argv[]){
	...
	cout << "Periodic Basis with d = " << d << ", d_ = " << d_ << ", j0 = " << j0 << ", J = " << J << endl << endl;
    ...
    Integral<Gauss,PeriodicBasis,PeriodicBasis> _integral(basis, basis);
