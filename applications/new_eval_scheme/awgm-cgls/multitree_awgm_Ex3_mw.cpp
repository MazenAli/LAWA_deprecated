#include "problem_Ex3_CDRSaw_mw.h"
...
//    awgm_parameters.stable_exp_res = WoMixedHWExpansion;
    ...
    awgm_parameters.info_filename = "awgm_ExCDRSaw_mw_conv_info.txt";
    awgm_parameters.plot_filename = "awgm_ExCDRSaw_mw_u_plot";
    awgm_parameters.write_intermediary_solutions = true;
    awgm_parameters.intermediary_solutions_filename = "awgm_ExCDRSaw_mw_u_Iteration";
...
//    						F, rightPrec, leftPrec, awgm_parameters, cgls_parameters);
    ...
    saveCoeffVector2D(u, basis2d_trial, "awgm_ExCDRSaw_mw_u.txt");
    return 0;
}
