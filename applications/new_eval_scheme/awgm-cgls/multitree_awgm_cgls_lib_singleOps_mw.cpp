...
//    FlexibleCompoundLocalOperator2D  	    transpLocalOperator2D(transpLocalOperatorVec);
	...
	*/
    ...
    // .... set them here:
    awgm_parameters.tol = 5e-03;
    awgm_parameters.plot_solution = false;
    awgm_parameters.verbose_extra = true;
    awgm_parameters.info_filename = "awgm_Ex1_mw_conv_info.txt";
    awgm_parameters.plot_filename = "awgm_Ex1_mw_u_plot";
    awgm_parameters.write_intermediary_solutions = true;
    awgm_parameters.intermediary_solutions_filename = "awgm_Ex1_mw_u_Iteration";
