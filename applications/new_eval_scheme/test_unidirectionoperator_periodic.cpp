...
typedef LaplaceOperator1D<T,RefinementBasis>                      	   RefinementBilinearForm1D;
...
int main (int argc, char *argv[]) {
    ...
    RefinementBilinearForm1D	   RefinementBil(refinementbasis);
    LocalOp1D                      localOp1D(basis,basis, RefinementBil);
