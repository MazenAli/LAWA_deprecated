...
typedef Basis<T, Orthogonal, Interval, Multi>						IntervalBasis_y;
...
typedef AdaptiveWeightedPDEOperator1D<T,Orthogonal, Interval, Multi>	  	BilinearForm_y;
typedef AdaptiveWeightedPDEOperator1D<T,Orthogonal, Interval, MultiRefinement>	  	RefinementBilinearForm_y;
...
T dp2(T /*y*/) {   return 0.;  }
 ...
 int main (int argc, char *argv[]) {
    ...
    for (int j=0; j<=numOfIter; ++j) {
        ...
        getSparseGridIndexSet(basis2d_trial,Lambda,j,0,0.2);
        ...
        aux_coeffs.clear();
        getSparseGridIndexSet(basis2d_test,checkLambda,j,0,0.2);
