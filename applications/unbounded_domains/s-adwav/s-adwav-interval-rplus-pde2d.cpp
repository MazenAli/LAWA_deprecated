...
int main (int argc, char *argv[]) {
    ...
    if (strcmp(argv[1],"CDF")==0) {
        ...
        SeparableFunction2D<T> PP_SepFunc1(TensorRefSols_PDE_Interval_RPlus<T>::H1_rhs_x,
                                           TensorRefSols_PDE_Interval_RPlus<T>::sing_pts_x,
                                           TensorRefSols_PDE_Interval_RPlus<T>::exact_y,
                                           TensorRefSols_PDE_Interval_RPlus<T>::sing_pts_y);
        SeparableFunction2D<T> PP_SepFunc2(TensorRefSols_PDE_Interval_RPlus<T>::exact_x,
                                           TensorRefSols_PDE_Interval_RPlus<T>::sing_pts_x,
                                           TensorRefSols_PDE_Interval_RPlus<T>::H1_rhs_y,
                                           TensorRefSols_PDE_Interval_RPlus<T>::sing_pts_y);
