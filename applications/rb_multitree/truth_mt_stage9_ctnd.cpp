...
int main () {
	...
	*/
    ...
    int old_N = 3;
    rb_system.read_rb_data("Runs/Stage9/Run2/training_data_stage9", old_N);
    rb_base.read_basisfunctions("Runs/Stage9/Run2/training_data_stage9/bf", old_N);
    rb_base.read_rieszrepresentors("Runs/Stage9/Run2/training_data_stage9/representors", old_N);
    rb_base.read_greedy_info("Runs/Stage9/Run2/awgm_stage9_greedy_info.txt", old_N);
