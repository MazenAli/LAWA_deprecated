...
int main () {
    ...
    Identity1D_Time_Test		IdentityBil_Test_t(basis_int, basis_int);
    ...
    RefConvection1D_Space 	    RefConvectionBil_x(basis_intbc.refinementbasis, basis_intbc.refinementbasis,
													zero_Fct, w_conv_Fct, zero_Fct, 10,true, false, true);
    RefIdentity1D_Time_Test 	RefIdentityBil_Test_t(basis_int.refinementbasis, basis_int.refinementbasis);
    ...
    LOp_Id1D_Time_Test		lOp_Id1D_Test_t (basis_int, basis_int, RefIdentityBil_Test_t, IdentityBil_Test_t);
	...
	*/
    ...
    awgm_rieszF.awgm_params.info_filename = "awgm_stage4_mw_rieszF_conv_info.txt";
    ...
    awgm_rieszA.awgm_params.info_filename = "awgm_stage4_mw_rieszA_conv_info.txt";
    ...
    rb_base.greedy_params.print_file = "awgm_stage4_mw_greedy_info.txt";
    rb_base.greedy_params.trainingdata_folder = "training_data_stage4_mw";
    ...
    rb_system.write_rb_data("offline_data_stage4_mw");
    rb_base.write_basisfunctions("offline_data_stage4_mw");
    rb_base.write_rieszrepresentors("offline_data_stage4_mw");
